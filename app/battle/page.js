                  ...
                  <div key={battle.id} className={styles.challengeCard}>
                    ...
                    <div>
                      {isOwn ? (
                        ...
                        <Link href="/login?redirect=/battle" className={styles.acceptBtn} style={{ textDecoration: 'none', display: 'inline-block' }}>
                          Sign in to accept →
                        </Link>
                      ) : (
                        <button className={styles.acceptBtn} onClick={() => acceptChallenge(battle)} disabled={accepting === battle.id}>
